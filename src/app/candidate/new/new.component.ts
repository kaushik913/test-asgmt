...
import {NgbDatepickerConfig, NgbInputDatepickerConfig, NgbModal} from '@ng-bootstrap/ng-bootstrap';
...
export class NewComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    this.experienceDetails = this.formBuilder.group({
      ...
      team_size: ['', [Validators.required, Validators.pattern('^([0-9]{1,3})?$')]],
  ...
  addCandidate() {
    ...
    this._commonService.apiCall('post', 'candidate', data).subscribe(response => {
